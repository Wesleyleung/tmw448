...
AWS_STORAGE_BUCKET_PREFIX = environ.get('AWS_STORAGE_BUCKET_PREFIX', '')
...
STATIC_URL = 'https://%s.s3.amazonaws.com/%s/' % (AWS_STORAGE_BUCKET_PREFIX, AWS_STORAGE_BUCKET_NAME)
