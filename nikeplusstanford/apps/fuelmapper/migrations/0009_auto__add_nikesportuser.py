...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NikeSportUser'
        db.create_table('fuelmapper_nikesportuser', (
        ...
        db.send_create_signal('fuelmapper', ['NikeSportUser'])


    def backwards(self, orm):
        # Deleting model 'NikeSportUser'
        db.delete_table('fuelmapper_nikesportuser')
