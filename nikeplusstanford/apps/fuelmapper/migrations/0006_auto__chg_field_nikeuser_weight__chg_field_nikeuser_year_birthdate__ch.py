...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NikeUser.weight'
        ...
        # Changing field 'NikeUser.height'
        db.alter_column('fuelmapper_nikeuser', 'height', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'NikeUser.country'
        db.alter_column('fuelmapper_nikeuser', 'country', self.gf('django.db.models.fields.CharField')(max_length=40, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'NikeUser.height'
        db.alter_column('fuelmapper_nikeuser', 'height', self.gf('django.db.models.fields.FloatField')(default=0))

        # Changing field 'NikeUser.country'
        db.alter_column('fuelmapper_nikeuser', 'country', self.gf('django.db.models.fields.CharField')(default='', max_length=40))
